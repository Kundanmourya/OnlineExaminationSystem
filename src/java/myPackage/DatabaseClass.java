...
public class DatabaseClass {
    ...
    public void addNewStudent(String fName,String lName,String uName,String email,String pass,
        ...
        try {
            String sql="INSERT into users(first_name,last_name,user_name,email,password,user_type,contact,city,address) "
                    + "Values(?,?,?,?,?,?,?,?,?)";
    ...
    public void updateStudent(int uId,String fName,String lName,String uName,String email,String pass,
        ...
        try {
            String sql="Update users"
                    + " set first_name=? , last_name=? , user_name=? , email=? , password=? , user_type=? , contact=? , city=? , address=? "
                    + " where user_id=?";
